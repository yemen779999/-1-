...
describe('Database Class Core Functionality', () => {
  let db: Database;
  ...
  it('should create new buyer and supplier accounts correctly', () => {
  ...
  it('should process debit and credit transactions and update running balance', () => {
  ...
  it('should handle relational sync between daily entries and account ledger', () => {
  ...
  it('should support multi-currency conversion accurately', () => {
  ...
  it('should soft delete and record deleted state for recycle bin recovery', () => {
    const acc = db.addAccount({
